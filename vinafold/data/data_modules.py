...
class VinaFoldDataset(torch.utils.data.Dataset):
    def __init__(self,
        ...
        """
            Args:
                ...
                alignment_dir:
                    ...
                    (defined in VinaFold.features.alignment_runner).
                ...
                config:
                    A dataset config object. See VinaFold.config
        ...
        #         "scripts/generate_mmcif_cache.py before running VinaFold"
        #     )
...
# class VinaFoldSingleMultimerDataset(torch.utils.data.Dataset):
#     def __init__(self,
#                  data_dir: str,
#                  alignment_dir: str,
#                  template_mmcif_dir: str,
...
#                     "train", "val", or "predict"
#         """
#         super(VinaFoldSingleMultimerDataset, self).__init__()
#         self.data_dir = data_dir
...
#         length of an VinaFoldFilteredDataset is arbitrary. Samples are selected
#         and filtered once at initialization.
#     """

#     def __init__(self,
#                  datasets: Union[Sequence[VinaFoldSingleDataset]],
...
# class VinaFoldMultimerDataset(VinaFoldDataset):
#     """
...
#     def __init__(self,
#                  datasets: Sequence[VinaFoldSingleMultimerDataset],
#                  probabilities: Sequence[float],
#                  epoch_len: int,
#                  generator: torch.Generator = None,
#                  _roll_at_init: bool = True
#                  ):
#         super(VinaFoldMultimerDataset, self).__init__(datasets=datasets,
...
class VinaFoldDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        # dataset_gen = partial(VinaFoldSingleDataset,
        #                       template_mmcif_dir=self.template_mmcif_dir,
        #                       max_template_date=self.max_template_date,
        #                       config=self.config,
        #                       kalign_binary_path=self.kalign_binary_path,
...
# class VinaFoldMultimerDataModule(VinaFoldDataModule):
#     """
#     Create a datamodule specifically for multimer training

#     Compared to VinaFoldDataModule, VinaFoldMultimerDataModule
...
#                  **kwargs):
#         super(VinaFoldMultimerDataModule, self).__init__(config,
#                                                          template_mmcif_dir,
#                                                          max_template_date,
#                                                          train_data_dir,
#                                                          **kwargs)
...
#         # Most of the arguments are the same for the three datasets 
#         dataset_gen = partial(VinaFoldSingleMultimerDataset,
#                               template_mmcif_dir=self.template_mmcif_dir,
#                               max_template_date=self.max_template_date,
#                               config=self.config,
#                               kalign_binary_path=self.kalign_binary_path,
...
#             self.train_dataset = VinaFoldMultimerDataset(
#                 datasets=datasets,
#                 probabilities=probabilities,
#                 epoch_len=self.train_epoch_len,
#                 generator=generator,
