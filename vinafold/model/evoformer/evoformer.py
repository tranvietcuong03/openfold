...
from vinafold.utils.checkpointing import checkpoint_blocks, get_checkpoint_fn
from vinafold.utils.chunk_utils import chunk_layer, ChunkSizeTuner
...
class EvoformerStack(nn.Module):
    ...
    def _forward_offload(self,
        ...
        blocks = self._prep_blocks(
            # We are very careful not to create references to these tensors in this function
            m=input_tensors[0],
            z=input_tensors[1],
            chunk_size=chunk_size,
            use_deepspeed_evo_attention=use_deepspeed_evo_attention,
